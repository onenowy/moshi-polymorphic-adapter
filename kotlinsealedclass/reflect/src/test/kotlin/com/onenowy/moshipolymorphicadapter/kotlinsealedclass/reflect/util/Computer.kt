...
sealed class Computer(
    val typeInt: ComTypeInt,
    val typeString: ComTypeString,
    val typeDouble: ComTypeDouble,
    val typeLong: ComTypeLong
) {
