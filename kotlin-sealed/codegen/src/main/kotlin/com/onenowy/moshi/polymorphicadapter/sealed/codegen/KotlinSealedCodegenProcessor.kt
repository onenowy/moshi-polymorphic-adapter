package com.onenowy.moshi.polymorphicadapter.sealed.codegen
...
import com.onenowy.moshi.polymorphicadapter.sealed.codegen.api.preparedAdapter
...
class KotlinSealedCodegenProcessor : AbstractProcessor() {
    ...
    companion object {
        ...
        internal val COMMON_SUPPRESS = SUPPRESS_NAMES.let { suppression ->
